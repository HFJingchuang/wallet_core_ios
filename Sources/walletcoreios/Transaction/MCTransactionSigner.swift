...
public struct Chain3Signer {
    ...
    /**
     ...
     - throws: Chain3UtilsError.cannotConvertDataToAscii, SECP256K1Error, AbstractKeystoreError
     */
//    public static func signIntermediate(intermediate: inout MCTransactionIntermediate, keystore: AbstractKeystore, account: Address, password: String, useExtraEntropy: Bool = false) throws {
